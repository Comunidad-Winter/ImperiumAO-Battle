...
Dim DaOro As Integer

DaExp = CInt(UserList(VictimIndex).Stats.ELV * 2)
DaOro = CInt(UserList(VictimIndex).Stats.ELV * 200)
...
If UserList(AttackerIndex).Stats.Exp > MAXEXP Then _
    ...
    UserList(AttackerIndex).Stats.GLD = UserList(AttackerIndex).Stats.GLD + DaOro
...
Sub ChangeUserInv(UserIndex As Integer, Slot As Byte, Object As UserOBJ)
    ...
    If Object.ObjIndex > 0 Then
        ...
        & ObjData(Object.ObjIndex).Valor \ 3 & "," _
        & IIf(SexoPuedeUsarItem(UserIndex, Object.ObjIndex) = True And FaccionPuedeUsarItem(UserIndex, Object.ObjIndex) = True And ClasePuedeUsarItem(UserIndex, Object.ObjIndex) = True, 1, 0))
        Else
